...
public final class FirstDayOfNextMonthCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(FirstDayOfNextMonthCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    FirstDayOfNextMonth command = new FirstDayOfNextMonth();
